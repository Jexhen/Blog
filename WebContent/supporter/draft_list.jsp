...
<body>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li  class="active"><a href="${pageContext.request.contextPath }/admin/getDraftToSupporter">草稿箱</a>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        	<c:forEach items="${drafts }" var="draft">
	                                        	<tr>
	                                                <td>
	                                                    <input type="checkbox" name="input[]" value="${draft.did }">
	                                                </td>
	                                                <td>${draft.dname }</td>
	                                                <td><a href="${pageContext.request.contextPath }/admin/editDraft?did=${draft.did }"><i class="fa fa-file-text text-navy"></i></a>
	                                                </td>
	                                                <td><a href="javascript:void(0)" onclick="deleteDraft('${draft.did }')"><i class="fa fa-times text-navy"></i></a>
	                                                </td>
	                                            </tr>
                                        	</c:forEach>
                                        </tbody>
    ...
    <script>
        $(function(){
        	...
        	$("#delete").click(function(){
        		...
        		if (isConfirm) {
	        		$.ajax({
	        			type:"post",
	        			url:"${pageContext.request.contextPath }/admin/removeDraft",
	        			data:{"dids":arr},
        ...
        function deleteDraft(did){
        	var isConfirm = confirm("您确认删除该篇草稿吗？");
        	if (isConfirm) {
        		$.ajax({
        			type:"post",
        			url:"${pageContext.request.contextPath }/admin/removeDraft",
        ...
        function searchByCondition() {
        	...
        	$.ajax({
        		type:"post",
        		url:"${pageContext.request.contextPath}/admin/getDraftByCondition",
        		data:param,
        		success:function(drafts){
        			var newTbody = "共为您查询到"+drafts.length+"条结果<br/>";
        			for (var i = 0; i < drafts.length; i++) {
						newTbody = newTbody + getNewTbodyEle(drafts[i]);
        			}
        			$("tbody").html(newTbody);
        		},
        		dataType:"json"
        ...
        function getNewTbodyEle(draft) {
        	var s1 = "<tr>";
            var s2 = "<td><input type='checkbox' name='input[]' value='"+draft.did+"'></td>";
            var s3 = "<td>"+draft.dname+"</td>";
            var s4 = "<td><a href='/admin/editArticle?aid="+draft.did+"'><i class='fa fa-file-text text-navy'></i></a></td>";
            var s5 = "<td><a href=\"javascript:void(0)\" onclick=\"deleteArticle('"+draft.did+"')\"><i class='fa fa-times text-navy'></i></a></td>";
            var s6 = "</tr>";
