        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-lg-8" style="background-color: #fff; border: 1px solid silver;padding-top:15px;">
                    ...
                    <div class="col-lg-8">
                            	...
                            	<c:forEach items="${carousel }" var="image" varStatus="cnt">
                           			<c:if test="${cnt.count==1 }">
                           				<div class="item active">
		                                    <img src="${image.csrc }" alt="${image.cdesc }">
						...
						<!--博客条目-->
						<div style="margin-top: 10px; border:1px dashed grey; padding:5px 5px; border-radius:8px;">
							<span class="glyphicon glyphicon-list-alt"></span>&nbsp;<span>最新发布</span>
						</div>
                        ...
                        <div style="margin-top: 10px; border:1px dashed grey; padding:5px 5px; border-radius:8px;">
                           ...
                           <div>
                               ...
                               <div style="color: #8c8c8c">
                                   ...
                                   <c:forEach items="${category }" var="citem">
                                   	...
                                   	<span class="glyphicon glyphicon-tags"></span>&nbsp;<span>${citem.cname }</span>
                                   	</c:if>
                                   </c:forEach>
                               </div>
                           </div>
                          ...
                          <!--正文预览-->
                          <div style="martin-bottom:5px;">${article.summary }</div>
                          <!--预览更多按钮-->
                          <a href="${pageContext.request.contextPath }/readArticle?cid=${cid }&aid=${article.aid }" class="btn btn-sm active" role="button">阅读更多</a>
                        </div>
						</c:forEach>
                        <!--分页-->
                        <!--页数-->
                        <div class="pull-left">
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                	<c:forEach begin="1" end="${page.totalPage }" varStatus="cnt">
                                		<c:if test="${page.currentPage==cnt.count }">
                                			<li class="active"><a href="${pageContext.request.contextPath }/getArticle?cid=${cid }&currentPage=${cnt.count }">${cnt.count }</a></li>
                                		</c:if>
                                		<c:if test="${page.currentPage!=cnt.count }">
                                			<li><a href="${pageContext.request.contextPath }/getArticle?cid=${cid }&currentPage=${cnt.count }">${cnt.count }</a></li>
                                		</c:if>
                                	</c:forEach>
                                </ul>
                            </nav>
                       ...
                       <div class="pull-right">
                           <nav aria-label="Page navigation">
                               <ul class="pagination">
                                   ...
                                   <c:if test="${page.currentPage!=1 }">
                               		<li>
                                        <a href="${pageContext.request.contextPath }/getArticle?cid=${cid }&currentPage=${page.currentPage-1 }" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
                                   	</li>
                               	</c:if>
                               	...
                               	<c:if test="${page.currentPage!=page.totalPage }">
                               		<li>
                                        <a href="${pageContext.request.contextPath }/getArticle?cid=${cid }&currentPage=${page.currentPage+1 }" aria-label="Next">
                                            <span aria-hidden="true">&raquo;</span>
                                        </a>
                                  	</li>
                               	</c:if>
